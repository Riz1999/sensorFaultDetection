...
from sensor.entity.config_entity import TrainingPipelineConfig,DataIngestionConfig,DataValidationConfig,DataTransformationConfig,DataTransformationConfig, ModelTrainerConfig
...
from sensor.constant import s3_bucket
...
#         self.training_pipeline_config = TrainingPipelineConfig()
    ...
    def sync_artifact_dir_to_s3(self):
        try:
            aws_buket_url = f"s3://{s3_bucket.TRAINING_BUCKET_NAME}/artifact/{self.training_pipeline_config.timestamp}"
    ...
    def sync_saved_model_dir_to_s3(self):
        try:
            aws_buket_url = f"s3://{s3_bucket.TRAINING_BUCKET_NAME}/{SAVED_MODEL_DIR}"
